...
void cSurface::Setup()
{
	...
	*/
	...
	v1 = D3DXVECTOR3(CENTERX + 10.1, FF, CENTERZ + 4); vecVertex.push_back(v1);
	v2 = D3DXVECTOR3(CENTERX + 13, FF, CENTERZ + 4); vecVertex.push_back(v2);
	...
	v0 = D3DXVECTOR3(CENTERX + 6.1, FF, CENTERZ - 0.4); vecVertex.push_back(v0);
	v1 = D3DXVECTOR3(CENTERX + 6.1, FF, CENTERZ + 4); vecVertex.push_back(v1);
	v2 = D3DXVECTOR3(CENTERX + 10.1, FF, CENTERZ + 4); vecVertex.push_back(v2);
	v3 = D3DXVECTOR3(CENTERX + 10.1, FF, CENTERZ - 0.4); vecVertex.push_back(v3);
	m_pFFLivingRoom2->Setup(v0, v1, v2, v3, NULL);
	//¹æ
	m_pFFRoom = new cRectMake;
	v0 = D3DXVECTOR3(CENTERX + 3, FF, CENTERZ - 0.4); vecVertex.push_back(v0);
	v1 = D3DXVECTOR3(CENTERX + 3, FF, CENTERZ + 4); vecVertex.push_back(v1);
	v2 = D3DXVECTOR3(CENTERX + 6, FF, CENTERZ + 4); vecVertex.push_back(v2);
	v3 = D3DXVECTOR3(CENTERX + 6, FF, CENTERZ - 0.4); vecVertex.push_back(v3);
	m_pFFRoom->Setup(v0, v1, v2, v3, NULL);
	//È­Àå½Ç
	m_pFBathRoom = new cRectMake;
	v0 = D3DXVECTOR3(CENTERX + 3, FF, CENTERZ - 4); vecVertex.push_back(v0);
	v1 = D3DXVECTOR3(CENTERX + 3, FF, CENTERZ - 0.5); vecVertex.push_back(v1);
